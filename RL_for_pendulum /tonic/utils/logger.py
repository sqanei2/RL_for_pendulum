...
class Logger:
    ...
    def __init__(self, path=None, width=60, script_path=None, config=None):
        ...
        self.log_file_path = os.path.join(self.path, 'log_tonic.csv')
        ...
        if script_path:
            with open(script_path, 'r') as script_file:
                ...
                try:
                    ...
                    pass
                script_path = os.path.join(self.path, 'script_tonic.py')
        ...
        if config:
            try:
                ...
                pass
            config_path = os.path.join(self.path, 'config_tonic.yaml')
